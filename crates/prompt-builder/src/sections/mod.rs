...
pub fn get_section(name: &str) -> Option<Section> {
    match name {
        ...
        "braindump_instructions" => {
            Some(instructions::braindump::braindump_instructions())
        }
        ...
        "discuss_instructions" => {
            Some(instructions::discuss::discuss_instructions())
        }
        "task_exec_instructions" => {
            Some(instructions::task_exec::task_exec_instructions())
        }
        "opus_review_instructions" => {
            Some(instructions::opus_review::opus_review_instructions())
        }
        _ => None,
    }
}
