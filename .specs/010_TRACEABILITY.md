...
| Playwright | `{file}::{test_name}` | `e2e/controls.spec.ts::start button works` |
...
|--------|---------------------|----------------|------|--------|
| REQ-060-01 | E2E tests use Playwright | `e2e/*.spec.ts` | CI run | ✓ |
| REQ-060-02 | Visual tests use Playwright | `e2e/visual/*.spec.ts` | CI run | ✓ |
```
